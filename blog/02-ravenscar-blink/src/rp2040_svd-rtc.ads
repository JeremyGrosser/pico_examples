...
package RP2040_SVD.RTC is
   ...
   subtype CLKDIV_M1_CLKDIV_M1_Field is RP2040_SVD.UInt16;
   ...
   subtype SETUP_0_DAY_Field is RP2040_SVD.UInt5;
   subtype SETUP_0_MONTH_Field is RP2040_SVD.UInt4;
   subtype SETUP_0_YEAR_Field is RP2040_SVD.UInt12;
   ...
   subtype SETUP_1_SEC_Field is RP2040_SVD.UInt6;
   subtype SETUP_1_MIN_Field is RP2040_SVD.UInt6;
   subtype SETUP_1_HOUR_Field is RP2040_SVD.UInt5;
   subtype SETUP_1_DOTW_Field is RP2040_SVD.UInt3;
   ...
   type SETUP_1_Register is record
      ...
      --  unspecified
      Reserved_21_23 : RP2040_SVD.UInt3 := 16#0#;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_2_3      : RP2040_SVD.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_9_31     : RP2040_SVD.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype IRQ_SETUP_0_DAY_Field is RP2040_SVD.UInt5;
   subtype IRQ_SETUP_0_MONTH_Field is RP2040_SVD.UInt4;
   subtype IRQ_SETUP_0_YEAR_Field is RP2040_SVD.UInt12;
   ...
   type IRQ_SETUP_0_Register is record
      ...
      --  unspecified
      Reserved_27_27 : RP2040_SVD.Bit := 16#0#;
   ...
   subtype IRQ_SETUP_1_SEC_Field is RP2040_SVD.UInt6;
   subtype IRQ_SETUP_1_MIN_Field is RP2040_SVD.UInt6;
   subtype IRQ_SETUP_1_HOUR_Field is RP2040_SVD.UInt5;
   subtype IRQ_SETUP_1_DOTW_Field is RP2040_SVD.UInt3;
   ...
   subtype RTC_1_DAY_Field is RP2040_SVD.UInt5;
   subtype RTC_1_MONTH_Field is RP2040_SVD.UInt4;
   subtype RTC_1_YEAR_Field is RP2040_SVD.UInt12;
   ...
   subtype RTC_0_SEC_Field is RP2040_SVD.UInt6;
   subtype RTC_0_MIN_Field is RP2040_SVD.UInt6;
   subtype RTC_0_HOUR_Field is RP2040_SVD.UInt5;
   subtype RTC_0_DOTW_Field is RP2040_SVD.UInt3;
   ...
   type RTC_0_Register is record
      ...
      MIN            : RTC_0_MIN_Field;
      --  unspecified
      Reserved_14_15 : RP2040_SVD.UInt2;
      --  Read-only. Hours
