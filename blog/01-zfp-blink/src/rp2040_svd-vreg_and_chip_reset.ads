...
package RP2040_SVD.VREG_AND_CHIP_RESET is
   ...
   subtype VREG_VSEL_Field is RP2040_SVD.UInt4;
   ...
   type VREG_Register is record
      ...
      --  unspecified
      Reserved_8_11  : RP2040_SVD.UInt4 := 16#0#;
   ...
   subtype BOD_VSEL_Field is RP2040_SVD.UInt4;
   ...
   type CHIP_RESET_Register is record
      ...
      --  unspecified
      Reserved_9_15    : RP2040_SVD.UInt7 := 16#0#;
      --  Read-only. Last reset was from the RUN pin
      HAD_RUN          : Boolean := False;
      --  unspecified
      Reserved_17_19   : RP2040_SVD.UInt3 := 16#0#;
